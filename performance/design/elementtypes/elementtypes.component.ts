...
@Component({
  selector: 'ngx-elementtype',
  styleUrls: ['./elementtypes.component.scss'],
  templateUrl: './elementtypes.component.html',
})
...
//UIP=kPb1TguiqNNfK28stVab7GONh0MVC4PSlvXeN7D5r67.0LDXa8GWH3&USR=201503040&PASS=BHFIB+8VcF5urJs/syTbYA==
  ...
  // }
     ...
     getElementTypes() {
        var uname = "201503040"; var upass = "BHFIB+8VcF5urJs/syTbYA=="; var query = "[SC.1261180887].ElementTypes"; var criteria = ""; var sortby = ""; var attributes = "id,name,typename,iconurl,level,scorecardid"; var options = "";
